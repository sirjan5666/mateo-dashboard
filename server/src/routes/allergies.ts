...
router.get('/babies/:id/allergies', requireAuth, loadOwnedBaby, async (req, res) => {
...
router.post('/babies/:id/allergies', requireAuth, loadOwnedBaby, async (req, res) => {
...
router.delete('/babies/:id/allergies/:allergyId', requireAuth, loadOwnedBaby, async (req, res) => {
